...
func init() {
	...
	RootCmd.PersistentFlags().DurationVar(&lifetime, "lifetime", 5*time.Minute, "total lifetime of bench tool")
	RootCmd.PersistentFlags().StringVar(&benchDataDesc, "database", "random", "description of test database")
}
